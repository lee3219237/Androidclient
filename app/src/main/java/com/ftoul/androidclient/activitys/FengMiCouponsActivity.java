...
import com.ftoul.androidclient.fragments.fmcoupons.NotUseFmCouponsFragment;
 ...
 * 蜂蜜券
 */
public class FengMiCouponsActivity extends BaseTitleActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feng_mi_coupons);
    }

    @Override
    protected void initView() {
        headerTitle.setText("蜂蜜券");
        rlHeaderLeft.setVisibility(View.VISIBLE);

        viewpager.setAdapter(new FengMiCouponsActivity.ViewPagerAdapter(getSupportFragmentManager()));
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return NotUseFmCouponsFragment.newInstance(position);
        }
